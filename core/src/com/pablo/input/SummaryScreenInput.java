...
public class SummaryScreenInput implements GestureDetector.GestureListener {

    private SummaryScreen summaryScreen;

    public SummaryScreenInput(SummaryScreen summaryScreen){
    ...
    public boolean fling(float velocityX, float velocityY, int button) {
       if (velocityX>0){
           summaryScreen.changeResultToDisplay(-1);
       }
       else if (velocityX<0){
           summaryScreen.changeResultToDisplay(+1);
       }
